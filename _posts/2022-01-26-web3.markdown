...
목시의 주장에 대해 비탈릭 부테린을 포함한 몇몇 블록체인 지지자들은 당연히 반박을 했습니다. 목시도 인정했듯이 아직 블록체인을 비롯한 Web 3의 모든 측면을 고려하지 못했기 때문에 간과한 부분이 있을 것입니다. 

비탈릭 부테린은 레딧의 [댓글][buterin]을 통해 목시가 지적한 현재의 Dapp 환경이 그런 부분이 있다는 것에 공감을 했습니다. 그러나 미래의 인터넷은 탈중앙화되어야 한다는 생각에는 변함이 없고 느리지만 그 흐름은 지속될 것이라고 말합니다. 
...
[buterin]: https://moxie.org/2022/01/07/web3-first-impressions.html