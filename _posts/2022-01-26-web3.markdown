...
"탈중앙화 극장(decentralization theater)"이라는 표현이 있습니다. 비트코인 지지자들이 무늬만 탈중앙화인 블록체인을 조롱할 때 쓰는 표현입니다. 영화는 현실이 아닙니다. 편집되고 검열될 수 있으며 흥행이 실패할 수도, 또 종국에는 상영이 중단됩니다. 비트코이너들이 다른 블록체인을 보는 관점은 "진짜" 블록체인이 아니라 영화같은(연출되고 규제될 수 있는) 블록체인이라는 의미를 내포합니다.
