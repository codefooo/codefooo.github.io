...
최근 인터넷에서 글로벌 IT 기업들의 리더들과 블록체인 창립자들이 서로 "Web 3"에 대해 논쟁을 벌이고 있습니다. Web 3는 탈중앙화 웹 또는 차세대 웹, 그러니까 현재 인터넷의 다음 버전에 해당하는 것으로 받아들이기 때문에 현재의 인터넷을 혁신할 다음 기술은 어떤 모습이 되어야 하는가에 대해 저마다 자신들의 백그라운드에 기반한 "확신"을 가지고 있는 것 같습니다. 코인데스크의 기사를 중심으로 어떤 이야기들이 있는지 살펴보도록 하겠습니다.
...
목시는 오히려 현재의 탈중앙화, Web 3가 사용자들을 가로막고 있다고 말합니다. 왜냐하면 높은 수수료 때문에 이용을 꺼려하기 때문입니다. 물론 "크립토"가 아니었다면 NFT 같은 
유행도 없었을 테지만 말입니다. 
