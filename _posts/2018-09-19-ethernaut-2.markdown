...
한 슬롯의 크기가 32바이트(256비트) 이므로 그 안에 들어갈 수 있는 것들은 다음 4개의 상태변수들입니다. 슬롯 내에서는 뒤에서부터 순서대로 채워집니다.
...
여기서 X는 모두 0이 아니면 어떤 값이라도 상관없겠습니다. 중요한 것은 하위 16비트가 되겠네요. 최종적인 메소드는 다음과 같습니다.
